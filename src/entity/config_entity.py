...
class MainConfig:
    def __init__(self,timestamp = datetime.now()):
        ...
        self.time = self.timestamp.strftime("%d_%m_%Y_%H_%M_%S")
...
class DataIngestionConfig:
    def __init__(self, main_config: MainConfig):
        ...
        self.ingested_dir = os.path.join(self.ingested_dir,const.IngestionSubDir2)

        self.raw_filepath = os.path.join(self.raw_dir,const.Raw_Data_Filename)
...
class DataValidationConfig:
    def __init__(self, main_config: MainConfig):
        ...
        self.invalid_dir = os.path.join(self.validation_dir,const.ValidationSubDir2)
        self.valid_dir = os.path.join(self.validation_dir,const.ValidationSubDir3)
...
class DataTransformationConfig:
    def __init__(self, main_config: MainConfig):
        ...
        self.tranformed_train_filepath = os.path.join(self.transformation_dir,const.Train_Filename.replace("csv","npy"))
        self.tranformed_test_filepath = os.path.join(self.transformation_dir,const.Test_Filename.replace("csv","npy"))

        self.tranformed_object_filepath = os.path.join(self.transformation_dir,const.Preprocessor_Obj)
        

class ModelTrainerConfig:
    def __init__(self, main_config: MainConfig):
        self.model_trainer_dir = os.path.join(main_config.dir,const.ModelTrainerDir)
        self.final_trained_model_filepath = os.path.join(main_config.dir,self.model_trainer_dir,const.ModelTrainerSubDir1,const.Model_Filename)
